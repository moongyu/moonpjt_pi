...
def parking_task_1():
    ...
    if distance >= 20 or distance_ch2 >= 20 :
        ...
        if delta_dist >= 2 :
            if distance >= distance_ch2 + 2 :
                dir_fb = fx
                dir_lr = rr
            elif distance_ch2 >= distance + 2 :
                dir_fb = fx
                dir_lr = ll
            else :
                dir_fb = init
...
def parking_task_3():
    ...
    if distance >= distance_ch2 + 2 :
        ...
        #print(distance)
        #print(distance_ch2)
        if (distance <= 20 or distance_ch2 <= 20) and rng >= 2 :
            dir_fb = bb
            dir_lr = init
            #dir_fb = bx
            #dir_lr = lx
...
def parking_task_4():
    ...
    if distance >= distance_ch2 + 5 :
        ...
        dir_fb = fx
        dir_lr = ll
    elif (distance <= 45 or distance_ch2 <= 45) and rng >= 2 :
        dir_fb = bb
        dir_lr = init
